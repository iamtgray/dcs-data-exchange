...
The four reference architectures (Level 1 Labeling, Level 1 Assured, Level 2 ABAC, Level 3 Encryption) cover a specific slice of the DCS problem space: strategic data sharing between three nations with reliable connectivity. Several scenarios need capabilities that don't exist in the current architectures.

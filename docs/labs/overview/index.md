...
Data-Centric Security (DCS) protects information by embedding security into the data itself, rather than relying on the network or systems around it.
...
DCS has three capabilities that build on each other:

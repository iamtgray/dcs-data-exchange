...
The TDF file contains encrypted data, a wrapped key, and an access policy. It doesn't matter where the file ends up -- a USB drive, a cloud bucket, an email attachment. Without KAS authorization, the data is unreadable. That's what data-centric security is about.
...
### 6. Not much infrastructure needed
